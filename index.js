...
import salonesRoutes from './src/routes/salonesRoute.js';  
import turnosRoutes from './src/routes/turnosRoute.js';     
...
app.get('/api/health', (req, res) => {
  res.status(200).json({
    ...
    features: [
      'BREAD completo para Servicios, Salones, Turnos y Usuarios',
      'Autenticación JWT',
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log('✅ BREAD: Servicios, Salones, Turnos, Usuarios');
