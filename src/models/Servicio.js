...
// Importamos la utilidad de error para lanzar errores con status HTTP específico
...
      
      return {
        // Usamos .toJSON() para asegurar que la respuesta sea un objeto limpio
...
      if (exists) {
        // Usamos createError para enviar 409 Conflict
...
      // Si es un error de negocio con status (409), lo relanzamos. Si no, lanzamos error 500.
...
        // La comprobación de duplicados ahora se hace comparando con el servicio_id actual
...
        // Usamos createError para enviar 400 Bad Request (por dependencia)
...
        // Usamos .toJSON() para que la respuesta sea un objeto limpio
